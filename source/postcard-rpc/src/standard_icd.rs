...
impl core::fmt::Display for WireError {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            WireError::DeserFailed => write!(f, "Deserialization of a message failed"),
            WireError::SerFailed => write!(f, "Serialization of a message failed, usually due to a lack of space to buffer the serialized form"),
            WireError::UnknownKey => write!(f, "The key associated with this request was unknown"),
            WireError::FailedToSpawn => write!(f, "The server was unable to spawn the associated handler, typically due to an exhaustion of resources"),
            WireError::KeyTooSmall => write!(f, "The provided key is below the minimum key size calculated to avoid hash collisions, and was rejected to avoid potential misunderstanding"),
        }
    }
}
